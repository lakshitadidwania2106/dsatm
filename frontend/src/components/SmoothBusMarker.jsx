...
// Create a custom DivIcon with bus-front.svg icon
const createBusIcon = (isSelected) => {
    const iconColor = isSelected ? '#16a34a' : '#0f172a'
    return L.divIcon({
      ...
      <div style="
        ...
        position: relative;
      ">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="white" viewBox="0 0 16 16" style="display: block;">
